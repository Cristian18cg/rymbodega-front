...
import useControl_Contrato_Retiro from "../../../hooks/useControl_Documentos_Retiro";
...
export const LogRegistrosRetiro = () => {
  const navigate = useNavigate();
  const { logregistroRetiro, setlogregistroRetiro, LogRegistroRetiro } =
    useControl_Contrato_Retiro();
        ...
        <Container fluid>
          ...
          <Navbar.Collapse id=" justify-content-end">
            <div className="navbar-nav me-auto mb-2 mb-md-0">
              ...
              <h4 className="text-center ">Registros carpeta retiro</h4>
            </div>
  ...
  const obtenerResponsable = () => {
    if (responsables.length === 0) {
      const nombresUnicos = logregistroRetiro.reduce(
